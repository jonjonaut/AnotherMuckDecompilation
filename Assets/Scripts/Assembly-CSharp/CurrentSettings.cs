...
public class CurrentSettings : MonoBehaviour
{
    ...
    public void UpdateSave()
    {
        ...
        this.UpdateDisableRecipes(SaveManager.Instance.state.disableRecipes);
    ...
    public void UpdateDisableRecipes(bool b)
    {
        Debug.Log("Setting disable recipe popups to: " + b.ToString());
        SaveManager.Instance.state.disableRecipes = b;
        SaveManager.Instance.Save();
    ...
    public void UpdateMusic(int i)
    {
        ...
        SaveManager.Instance.Save();
        MusicController.Instance.audioSource.volume = (float)i / 10f;
