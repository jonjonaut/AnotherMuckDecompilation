...
public class Settings : MonoBehaviour
{
    ...
    private void UpdateSave()
    {
        ...
        using (var page = new SettingsPage(nav.settingMenus[0]))
        {
            ...
            page.AddBoolSetting("Disable Recipe Popups", SaveManager.Instance.state.disableRecipes, UpdateDisableRecipes);
        }
    ...
    private void UpdateDisableRecipes(bool current)
    {
        CurrentSettings.Instance.UpdateDisableRecipes(current);
    }
